	...
	const privacy = [
		{
			...
			tag: 'h1 p p p p',
			text: [
				'Политика о конфиденциальности в отношении обработки персональных данных субъектов ООО «БШ Стор» г. Москва',
				'Политика ООО «БШ Стор» (далее по тексту именуемого кратко- «Общество») в отношении обработки персональных данных (далее кратко именуемая — «Политика») определяет его позицию и намерения в области обработки и защиты персональных данных любых субъектов, с целью соблюдения и защиты прав и свобод каждого человека и, в особенности, права на неприкосновенность частной жизни, личную и семейную тайну, защиту своей чести и доброго имени.',
				'Политика неукоснительно исполняется всеми специалистами, привлекаемыми Обществом.',
